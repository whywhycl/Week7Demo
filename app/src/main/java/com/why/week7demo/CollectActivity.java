...
public class CollectActivity extends AppCompatActivity {
    ...
    private CollectSQLiteOpenHelper mHelper;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mHelper = new CollectSQLiteOpenHelper(this);
    ...
    private void initListView() {
        ...
        mListView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                Intent intent = new Intent(CollectActivity.this, TeaDetailActivity.class);
        ...
        mListView.setOnItemLongClickListener(new AdapterView.OnItemLongClickListener() {
            ...
            public boolean onItemLongClick(AdapterView<?> parent, View view, final int position, long id) {
                ...
                final AlertDialog.Builder builder = new AlertDialog.Builder(CollectActivity.this);
